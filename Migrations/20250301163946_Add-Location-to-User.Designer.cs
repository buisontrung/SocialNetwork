...
namespace SocialNetwork.Migrations
{
    ...
    [Migration("20250301163946_Add-Location-to-User")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialNetwork.Models.ConversationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SocialNetwork.Models.Follower", b =>
                {
                    b.HasOne("SocialNetwork.Models.ApplicationUser", "FollowerUser")
                        .WithMany("Following")
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SocialNetwork.Models.ApplicationUser", "FollowingUser")
                        .WithMany("Followers")
            ...
            modelBuilder.Entity("SocialNetwork.Models.FriendRequest", b =>
                {
                    b.HasOne("SocialNetwork.Models.ApplicationUser", "Receiver")
                        .WithMany()
